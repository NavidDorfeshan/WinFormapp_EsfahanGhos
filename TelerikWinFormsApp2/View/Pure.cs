...
{
    public partial class Pure : UserControl
    {
    ...
    && e.KeyChar != '.')
        ...
        private void GetData()
        {
            ...
            {
                ListPurchaseList = db.PurchaseLists.ToList();

            }
        }

        private void Pure_Load(object sender, EventArgs e)
        {
            BGW.RunWorkerAsync();
        }
        private bool CheckError()
        {
           // if (Txt_Price.Text.Trim() == "" || Txt_Name.Text.Trim() == "")
           //     return false;
           // else 
            return true;
        }
        private void Clear()
        {
            Txt_Price.Text = Txt_Desc.Text = Txt_Reason.Text = Txt_Name.Text = "";
        ...
        private void Btn_Edit_Click(object sender, EventArgs e)
        {
            if (CheckError())
            {
                ...
                if (project != null)
                    project.TotalCost += PaymentE.Cost; db.SaveChanges();
